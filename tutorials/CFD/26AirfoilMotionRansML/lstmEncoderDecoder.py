...
class Net:
    def __init__(self, Nnut, Epochs=2000): #2000
        # self.Nu = Nu
        self.Nnut = Nnut
        self.Epochs = Epochs
    ...
    def read(self):
        ...
        scaling = {"scaler_inp": preprocessing.MinMaxScaler( feature_range = (0, 1) ), "scaler_out": preprocessing.MinMaxScaler(feature_range = (0, 1) ) } ##feature_range = (-1, 1)
