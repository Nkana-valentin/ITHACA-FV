...
#include "createFields.H" 
        ...
        PtrList<volVectorField> Tfield; //List of feld to save div(phi, U) solution 
        ...
        public:
           ...
           std::cout << "============================       inside reduced deim=================================" << std::endl;
                ...
                void onlineSolve(int NmodesU,  int NmodesP, int NmodesS, fileName folder = "./ITHACAoutput/Online") 
                {
                    ...
                    volVectorField T2("Tonline", Foam2Eigen::Eigen2field(T, c)); //Field to save div(phi, U) solution using deim points
                    Info << "###########################################################" << endl;
        #include "createUfIfPresent.H"
