...
#include "createFields.H" 
        ...
        PtrList<surfaceVectorField> Uffield; 
        ...
        void offlineSolve(fileName folder = "./ITHACAoutput/Offline") 
        {
            ...
            volVectorField& divflux = (fvc::div(_phi())).ref();
...
//#include "createUfIfPresent.H"
            ...
            ITHACAstream::exportSolution(Uf, name(counter), folder);
        ...
        {
            dynamicFvMesh& mesh = meshPtr();
            DEIMObject = new vVf(Tfield, NmodesS, "divflux", _T().name());
