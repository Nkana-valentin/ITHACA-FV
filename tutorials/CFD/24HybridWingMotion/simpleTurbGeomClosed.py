...
class Net:
    ...
    def read(self):
        ...
        ## U
        U_data_set = np.load("coeffsFromMyPc/coeffL2U.npy")
        U_data_set = U_data_set[0:1001]
        #self.U_data_set = U_data_set
       
        ## Nut
        nut_data_set = np.load("coeffsFromMyPc/coeffL2Nut.npy")
        nut_data_set = nut_data_set[0:1001]
        #self.nut_data_set = nut_data_set
        
        inp_np_train_U, inp_np_test_U, out_np_train, out_np_test = train_test_split(U_data_set,nut_data_set, test_size=0.4, random_state=1234,shuffle=False) 
        ## Prepare dataset
    ...
    def Net1(self,inp_np_train, inp_np_test, out_np_train, out_np_test, Epochs, learning_rate=learning_rate, batch_size=batch_size):
        ...
        print(scaling["scaler_inp"].min_[:,None])
        sys.exit(0)
        ...
        # print(scaling["scaler_inp"].scale_[:,None])
        # sys.exit(0)
