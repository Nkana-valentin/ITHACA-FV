...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    reduced.timeStep =   0.001;
    reduced.writeEvery = 0.1;
    ...
    // Eigen::MatrixXd errL2C = ITHACAutilities::errorL2Abs(example.CenterOfMassy, reduced.CenterOfMassy);
    // Eigen::MatrixXd errL2V = ITHACAutilities::errorL2Abs(example.Vely, reduced.Vely);
    // ITHACAstream::exportMatrix(errL2C, "errL2C", "python","./ITHACAoutput/Errors2C/");
    // ITHACAstream::exportMatrix(errL2V, "errL2V", "python","./ITHACAoutput/Errors2V/");
